...
const createCaptureOverlay = (startEvent: React.MouseEvent) => {
  ...
  captureOverlay.style.cursor = window.getComputedStyle(
    ...
    <>
      ...
      {showHandle && (
        <rect
          ...
          width={
            isVertical
              ? HANDLE_CONFIG.EDGE.THICKNESS
              : HANDLE_CONFIG.EDGE.LENGTH
          }
          height={
            isVertical
              ? HANDLE_CONFIG.EDGE.LENGTH
...
export const ResizeHandles: React.FC<ResizeHandlesProps> = ({
  ...
  const handleMouseDownDimensions = (
    ...
    const onMouseMove = (moveEvent: MouseEvent) => {
      ...
      const heightChanged =
        newElementDimensions.height !== startDimensions.height;
