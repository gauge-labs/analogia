...
export const TAG_INFO: Record<string, TagInfo> = {
  ...
  li: {
    title: "List Item",
    description:
      "Represents an item in a list. It can only appear inside a list element, like <ul> or <ol>.",
  },
  img: {
    title: "Image",
  ...
  input: {
    title: "Input",
    description:
      "An element is used to create interactive controls for web-based forms in order to accept data from the user.",
  },
  label: {
    title: "Label",
  ...
  canvas: {
    title: "Canvas",
    description:
      "Provides a resolution-dependent bitmap area, which can be used for rendering graphs, game graphics, or other visual images on the fly.",
  },
  footer: {
    title: "Footer",
    description:
  ...
  main: {
    title: "Main",
    description:
      "Represents the main content of the <body> of a document or application. The main content area consists of content that is directly related to or expands upon the central topic of a document or central functionality of an application.",
  },
  section: {
    title: "Section",
    description:
  ...
  summary: {
    title: "Summary",
    description:
      "Represents a summary, caption, or legend for the rest of the contents of the <details> element, if any.",
  },
  dialog: {
    title: "Dialog",
    description:
  ...
  figcaption: {
    ...
    description:
      "Represents a caption or legend for the rest of the contents of the <figure> element, if any.",
  },
  hr: {
  ...
  em: {
    title: "Emphasis",
    description: "Represents stress emphasis of its contents.",
  },
  mark: {
    title: "Mark",
    description:
      "Represents highlighted text, i.e., a run of text marked for reference purpose, due to its relevance in a particular context.",
  },
  cite: {
    title: "Citation",
    description:
      "Represents the title of a work (e.g. a book, a paper, an essay, a poem, a score, a song, a script, a film, a TV show, a game, a sculpture, a painting, a theater production, a play, an opera, a musical, an exhibition, a legal case report, or a legal code).",
  },
};
