import { assistant1, assistant2 } from "@analogia/ai/src/prompt/edit/example";
...
const MOCK_USER_MSG = new UserChatMessageImpl(
  "Test message with some selected files",
  [
    {
      type: MessageContextType.FILE,
      path: "/Users/kietho/workplace/analogia/test/test/app/page.tsx",
